...
import { ISeteUsageData } from '../../../../helpers/regionHelpers';
...
interface IFilterComponent {
    markers: ISeteUsageData;
    markerFilter: keyof ISeteUsageData;
    setMarkerFilter: React.Dispatch<React.SetStateAction<keyof ISeteUsageData>>;
}
