...
type menuNavTypes = 'section_user_register' | 'section_user_list';

interface IBoxNavMenuProps {
    navActive: menuNavTypes;
    setNavActive: React.Dispatch<React.SetStateAction<menuNavTypes>>;
}

const BoxNavMenu: React.FC<IBoxNavMenuProps> = ({
    navActive,
    setNavActive,
}) => {
    return (
